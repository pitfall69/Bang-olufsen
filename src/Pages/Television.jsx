...
const Television = () => {
  const Productsdata = [
    {},
    {
      ...
      productImage: "src/assets/images/Television/BEOVISION HARMONY.webp",
      price: "$3,199",
    },
    {
      title: "BEOVISION THEATRE",
      des: "Cinematic home theatre",
      productImage: "src/assets/images/Television/BEOVISION THEATRE.webp",
      price: "$3,199",
    },
    {
      title: "BEOVISION CONTOUR",
      des: "All-in-one OLED TV",
      productImage: "src/assets/images/Television/BEOVISION CONTOUR.webp",
      price: "$3,199",
    },
    {
      title: "BEOREMOTE HALO",
      des: "Easy access to Music and Smart Home",
      productImage: "src/assets/images/Television/BEOREMOTE HALO.webp",
      price: "$900",
    },
    {
      title: "BEOCONNECT CORE",
      des: "Elevate your legacy",
      productImage: "src/assets/images/Television/BEOCONNECT CORE.webp",
      price: "$1150",
    },
    {
      title: "BEOSOUND CORE",
      des: "The heart of your music",
      productImage: "src/assets/images/Television/BEOSOUND CORE.webp",
      price: "$1,100",
    },
    {
      title: "BEOREMOTE ONE",
      des: "Do more with less",
      productImage: "src/assets/images/Television/BEOREMOTE ONE.webp",
      price: "$450",
    },
    {
      title: "BEOSOUND STAGE",
      des: "Powerful Dolby Atmos soundbar",
      productImage: "src/assets/images/Television/BEOSOUND STAGE.webp",
      price: "$1,150",
    },
  ];
