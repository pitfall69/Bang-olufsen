...
//           <div className="w-full h-full flex flex-col justify-center items-center max-sm:hidden gap-10 bg-red-500">
//             <p ref={TextReveal} className="font-Primary py-1 max-sm:text-sm text-">{item.Description}</p>
//             <p ref={TextReveal} className="text-lg w-[80%]  font-Secondary  max-lg:text-sm">{item.para}</p>
//           </div>
//         </div>
//       </div>
//     ))}
