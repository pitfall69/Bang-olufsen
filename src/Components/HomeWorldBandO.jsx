...
//   return (
//     <div className="w-full h-full p-5 flex flex-col max-sm:gap-[15vw] max-md:gap-[25vw] max-lg:gap-[30vw] gap-10  bg-white">
...
//         >
//           <div className="service-info max-sm:h-[50vh]">
//             <h1 className="text-3xl max-sm:text-xl max-lg:text-3xl uppercase font-primary">
//               {item.category}
//             </h1>
//             <div className="py-5">
//               <h2 className="text-lg py-2 opacity-60 font-primary uppercase max-sm:text-xs max-lg:text-xl">
//                 {item.title}
//               </h2>
...
//             </div>
//           </div>
//           <div className="service-img sm:px-10">
//             <div className="img w-[30%] max-sm:w-[50%] h-full">
//               <img
