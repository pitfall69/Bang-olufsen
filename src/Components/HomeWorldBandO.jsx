...
//         <TextAnimation text={"World of b & o"} textSize={"text-[10rem]"}/>
//         <BorderAnim customindex={1} />
//       <div className="w-full h-fit bg-red-500 p-5 flex pt-[10vh] max-sm:pt-[5vh] flex-col max-sm:gap-[15vw] max-md:gap-[vw] max-lg:gap-[30vw] gap-10 ">
...
const HomeWorldBandO = React.memo(() => {
        ...
        ScrollTrigger.create({
          ...
          onUpdate: (self) => {
            ...
            if (screenWidth < 640) {
              ...
              newFontSize = 1.3 + 1.8 * progress;
            } else if (screenWidth < 1280) {
              newFontSize = 1 + 1.3 * progress;
            } else if (screenWidth < 1563) {
              newFontSize = 1 + 2 * progress;
            } else {
              newFontSize = 2 + 1.8 * progress;
            }
            gsap.to(title, {
              fontSize: `${newFontSize}rem`,
              duration: 0.1,
  ...
  return (
    <div className="bg-white py-[5vh]">
      <TextAnimation
        text={"World of b & o"}
        textSize={"text-[10rem] max-xl:text-[5rem] max-sm:text-[3rem]"}
      />
      <BorderAnim customindex={1} />
      <div className="w-full px-5 flex flex-col gap-10 overflow-hidden sm:pb-[15vh] sm:pt-[5vh] max-sm:pt-[15vh] max-sm:gap-8 max-md:gap-[12rem] max-lg:gap-[16rem]">
        {homebandodata.map((item, index) => (
          <div
            key={index}
            className="service flex flex-col lg:flex-row gap-10 items-center h-full justify-between w-full max-lg:gap-5"
          >
            <div className="service-info  max-w-full lg:max-w-[25%]">
              <h1 className="text-3xl max-sm:text-xl max-lg:text-3xl uppercase font-primary">
                {item.category}
              </h1>
              <div className="py-5">
            ...
            <div className="service-img w-full lg:w-[75%] h-full">
