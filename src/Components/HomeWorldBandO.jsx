  ...
  return (
    <div className="bg-[#F5ECE7] py-[5vh]">
      <div className="w-full ">
        <h1
          ref={wbandoref}
          className="text-[10rem] w-full h-fit text-center overflow-hidden uppercase bg-[#F5ECE7] font-Secondary"
        >
          World of B&O
        </h1>
      </div>
      <div className="w-full h-full p-5 flex pt-[20vh] flex-col max-sm:gap-[15vw] max-md:gap-[25vw] max-lg:gap-[30vw] gap-10 bg-[#F5ECE7]">
